...
public class Main {
	final static String FILE_NAME = "d:/222/1.txt";
	final static String OUTPUT_FILE_NAME = "d:/222/2.txt";
	

	public static void main(String[] args) throws IOException {
		StringBuilder htmlContent = new StringBuilder();
		htmlContent.append("<table border='1' cellpadding='5' style='border-collapse: collapse; border: 1px solid black;'>");
		htmlContent.append("<tr><th>Имя</th><th>Тип</th><th>Дата создания</th><th>Размер</th></tr>");
